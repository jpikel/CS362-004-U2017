 ...
 * ONID: pikelj
 * Assignment: #3
 * Description: this is a unit test file for the smithy_effect function in dominion.c
 * *************************************/
 ...
 * Parameters: none
 * Preconditions: none
 * Postconditions: unit test the smithy_effect function
...
int main(void){
    ...
    for ( p = 2; p < 5; p++){
        ...
        validate(result, 0);
        printf("Unit test for the smithy_effect function, with %d players\n", p);
        ...
        validate(smithy_effect(0, 5, testGame), RETSUCCESS);
